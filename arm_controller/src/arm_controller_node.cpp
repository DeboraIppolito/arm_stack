...
int main(int argc, char **argv) {
 ...
 // Creazione di un vettore di 4 elementi di tipo std_msgs::Float64
    ...
    ros::spinOnce();
    loop_rate.sleep();
   /*In questo modo, ros::spinOnce() all'interno del ciclo while consente di elaborare i messaggi in arrivo sul subscriber 
   mentre il nodo continua a pubblicare messaggi con il publisher.
   Questo assicura che il nodo funzioni correttamente sia come subscriber che come publisher.*/
